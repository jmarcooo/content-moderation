...
<head>
    ...
    <style>
        ...
        /* Highlight style for restricted words */
        .restricted-text { background-color: rgba(210, 153, 34, 0.4); border-bottom: 2px solid #d29922; color: #7a5209; font-weight: bold; padding: 0 2px; border-radius: 2px; }
            ...
            <div class="content-canvas">
                ...
                <div id="module-text" style="margin-top: 30px;">
                    ...
                    <div class="action-module">
                        ...
                        <button class="btn-sm btn-restrict-sm" onmousedown="event.preventDefault()" onclick="ReviewApp.setStatus('text', 'restrict', '', true)">Restrict</button>
    ...
    <script>
        ...
        const ReviewApp = {
            ...
            setStatus(target, status, reason='', preserve=false) {
                ...
                // Only clear highlights if NOT preserving (e.g., clicking Approve or Reject)
            ...
            handleTextSelection(slot) {
                ...
                if (selection.rangeCount > 0 && !selection.isCollapsed && box.contains(selection.anchorNode)) {
                    // FIX: REMOVED clearAllHighlights() here so we don't destroy the selection before wrapping it!
                    ...
                    try {
                        ...
                        // Call setStatus with preserve=true so we don't wipe what we just did
                        this.setStatus('text', 'restrict', '', true);
                    } catch (e) { console.log("Highlight error (overlap?)", e); }
                }
            },
