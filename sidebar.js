...
const TRANSLATIONS = {
    // UPDATED: Brand name changed to "Community Admin Panel"
    en: { brand: "Community Admin Panel", overview: "Overview", users: "User Management", mod: "Moderation Queue", audit: "Quality Audit", appeal: "Appeal Center", notifs: "Notifications", settings: "Settings", logout: "Logout", online: "Online", break: "Break", lunch: "Lunch", meeting: "Meeting", idle: "Idle", training: "Training", offline: "Offline" },
    zh: { brand: "社区管理后台", overview: "总览", users: "用户管理", mod: "审核队列", audit: "质量质检", appeal: "申诉中心", notifs: "通知中心", settings: "设置", logout: "退出登录", online: "在线", break: "小休", lunch: "午餐", meeting: "会议", idle: "空闲", training: "培训", offline: "离线" }
};
...
function updateThemeIcon(mode) { 
    if(themeBtn) themeBtn.innerHTML = (mode === 'dark') ? ICONS.moon : ICONS.sun; 
}
